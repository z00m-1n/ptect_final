...
const HistoryDetailThree: React.FunctionComponent = ({navigation}:any) => {
        ...
        <View style={{ padding: constant.viewPadding }}>
          ...
          <View style={generalStyle.greyArea}>
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={{ flex: 7 }}>
                <Text style={{ fontSize: 17, color: "#000000" }}>: 202303061222</Text>
              </View>
            </View>
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 3 }}>
              ...
              <View style={{ flex: 7 }}>
                <Text style={{ fontSize: 17, color: "#000000" }}>: 2023년 03월 06일</Text>
              </View>
            </View>
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 3 }}>
...
export default HistoryDetailThree;
